...
### Figura 9: Adicionando os Hosts no PC4
<img src = "imagesPC4/setandohostsPC4.png" />
     
- Mudar as configurações de IP e a rede para NAT .

### Figura 10: Configurações de rede - PC1 - Emylle
<img src = "imagesEmylle/NAT.png" />

### Figura 11: Configurações de rede - PC2 - Renata
...
### Figura 13: Instalando o ssh - PC2 - Renata
<img src = "imagesRenata/SSH.png" />

### Figura 14: Instalando o ssh - PC3 - Jefferson
...
### Figura 15: Verificando status SSH - PC1 - Emylle
<img src = "imagesEmylle/Listen.png" />

### Figura 16: Verificando status SSH - PC2 - Renata
<img src = "imagesRenata/Lsiten.png" />

### Figura 17: Verificando status SSH - PC4
...
### Figura 18: Verificando status Firewall - PC 1 - Emylle
<img src = "imagesEmylle/firewall.png" />

### Figura 19: Verificando status Firewall - PC 2 - Renata
<img src = "imagesRenata/StatusFirewall.png" />

### Figura 20: Verificando status Firewall - PC 3 - Jefferson
<img src = "imagesJefferson/Status firewal - jefferson.png" />

### Figura 21: Verificando status Firewall - PC 4
...
### Figura 22: Criando users - PC 2 - Renata
<img src = "imagesRenata/AddUser.png" />
 
 ### Figura 23: Criando users - PC 4
<img src = "imagesPC4/adicionandousersPC4.png" />
 
### Figura 24: Users criados - PC 1 - Emylle
<img src = "imagesEmylle/usuarios.png"/>

### Figura 25: Users criados - PC 2 - Renata
...
### Figura 28: Config de host - PC 1 - Emylle
<img src = "imagesEmylle/hosts.png" />

### Figura 29: Config de host - PC 2 - Renata
<img src = "imagesRenata/ArquivoHosts.png" />

### Figura 30: Config de host - PC 3 - Jefferson
<img src = "imagesJefferson/hosts.png" />
 
 ### Figura 31: Config de host - PC 4
...
### Figura 32: Endereço MAC e modo bridge - PC 1 VM1- Emylle
<img src = "imagesEmylle/modo bridge - vm01.png" />

### Figura 33: Endereço MAC e modo bridge - PC 1 VM2- Emylle
...
### Figura 36: Endereço MAC e modo bridge - PC 4 VM2
